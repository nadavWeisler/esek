...
def from_data(
    ...
    p_value_unadjusted_normal_approximation_wilcoxon = min(
        float(norm.sf((abs(z_unadjusted_normal_approximation_wilcoxon))) * 2), 0.99999
    )
    ...
    lower_ci_z_based_pratt, upper_ci_z_based_pratt = self.compute_confidence_interval(
    ...
    results.corrected_z_based_biserial_wilcoxon = corrected_z_based_biserial_wilcoxon
