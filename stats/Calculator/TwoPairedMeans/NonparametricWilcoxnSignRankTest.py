...
class Aparametric_Paired_Samples():
    ...
    def Apermetric_Effect_Size_Dependent(params: dict) -> dict:
        ...
        LowerCi_Matched_Pairs_Wilcoxon = max(math.tanh(math.atanh(Matched_Pairs_Rank_Biserial_Corelation_ignoring_ties) - Z_Critical_Value * Standrd_Error_Match_Pairs_Rank_Biserial_Corelation_no_ties),-1)
        UpperCi_Matched_Pairs_Wilcoxon = min(math.tanh(math.atanh(Matched_Pairs_Rank_Biserial_Corelation_ignoring_ties) + Z_Critical_Value * Standrd_Error_Match_Pairs_Rank_Biserial_Corelation_no_ties),1)
        LowerCi_Z_basesd_Wilcoxon = max(math.tanh(math.atanh(Z_based_Rank_Biserial_Correlation_no_ties) - Z_Critical_Value * Standrd_Error_Match_Pairs_Rank_Biserial_Corelation_no_ties),-1)
        UpperCi_Z_basesd_Wilcoxon = min(math.tanh(math.atanh(Z_based_Rank_Biserial_Correlation_no_ties) + Z_Critical_Value * Standrd_Error_Match_Pairs_Rank_Biserial_Corelation_no_ties),1)
        LowerCi_Z_basesd_corrected_Wilcoxon = max(math.tanh(math.atanh(Z_based_Rank_Biserial_Correlation_corrected_no_ties) - Z_Critical_Value * Standrd_Error_Match_Pairs_Rank_Biserial_Corelation_no_ties),-1)
        UpperCi_Z_basesd_corrected_Wilcoxon = min(math.tanh(math.atanh(Z_based_Rank_Biserial_Correlation_corrected_no_ties) + Z_Critical_Value * Standrd_Error_Match_Pairs_Rank_Biserial_Corelation_no_ties),1)
        
        LowerCi_Matched_Pairs_Pratt = max(math.tanh(math.atanh(Matched_Pairs_Rank_Biserial_Corelation_Considering_ties) - Z_Critical_Value * Standrd_Error_Match_Pairs_Rank_Biserial_Corelation_with_ties),-1)
        UpperCi_Matched_Pairs_Pratt = min(math.tanh(math.atanh(Matched_Pairs_Rank_Biserial_Corelation_Considering_ties) + Z_Critical_Value * Standrd_Error_Match_Pairs_Rank_Biserial_Corelation_with_ties),1)
        LowerCi_Z_basesd_Pratt = max(math.tanh(math.atanh(Z_based_Rank_Biserial_Correlation_with_ties) - Z_Critical_Value * Standrd_Error_Match_Pairs_Rank_Biserial_Corelation_with_ties),-1)
        UpperCi_Z_basesd_Pratt = min(math.tanh(math.atanh(Z_based_Rank_Biserial_Correlation_with_ties) + Z_Critical_Value * Standrd_Error_Match_Pairs_Rank_Biserial_Corelation_with_ties),1)
        LowerCi_Z_basesd_corrected_Pratt = max(math.tanh(math.atanh(Z_based_Rank_Biserial_Correlation_corrected_with_ties) - Z_Critical_Value * Standrd_Error_Match_Pairs_Rank_Biserial_Corelation_with_ties),-1)
        UpperCi_Z_basesd_corrected_Pratt = min(math.tanh(math.atanh(Z_based_Rank_Biserial_Correlation_corrected_with_ties) + Z_Critical_Value * Standrd_Error_Match_Pairs_Rank_Biserial_Corelation_with_ties),1)
        ...
        results["Lower CI Matched Pairs Rank Biserial Wilcoxon"] = round(LowerCi_Matched_Pairs_Wilcoxon,5)
        results["Upper CI Matched Pairs Rank Biserial Wilcoxon"] = round(UpperCi_Matched_Pairs_Wilcoxon,5)
        results["Lower CI Z-based Rank Biserial Wilcoxon"] = round(LowerCi_Z_basesd_Wilcoxon,5)
        results["Upper CI Z-based Rank Biserial Wilcoxon"] = round(UpperCi_Z_basesd_Wilcoxon,5)
        results["Lower CI Z-based Corrected Rank Biserial Wilcoxon"] = round(LowerCi_Z_basesd_corrected_Wilcoxon,5)
        results["Upper CI Z-based Corrected Rank Biserial Wilcoxon"] = round(UpperCi_Z_basesd_corrected_Wilcoxon,5)  
        ...
        results["Lower CI Matched Pairs Rank Biserial Pratt"] = round(LowerCi_Matched_Pairs_Pratt,5)
        results["Upper CI Matched Pairs Rank Biserial Pratt"] = round(UpperCi_Matched_Pairs_Pratt,5)
        results["Lower CI Z-based Rank Biserial Pratt"] = round(LowerCi_Z_basesd_Pratt,5)
        results["Upper CI Z-based Rank Biserial Pratt"] = round(UpperCi_Z_basesd_Pratt,5)
        results["Lower CI Z-based Corrected Rank Biserial Pratt"] = round(LowerCi_Z_basesd_corrected_Pratt,5)
        results["Upper CI Z-based Corrected Rank Biserial  Pratt"] = round(UpperCi_Z_basesd_corrected_Pratt,5)
