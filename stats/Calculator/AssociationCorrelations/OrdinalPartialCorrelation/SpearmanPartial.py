...
class Partial_Correlation_Spearman():
    ...
    def partial_correlation_from_data(params: dict) -> dict:
        ...
        Lower_CI_Partial = np.tanh(np.arctanh(partial_correlation) - zcrit * Bonett_Wright_Standard_Error_partial)
        Upper_CI_Partial = np.tanh(np.arctanh(partial_correlation) + zcrit * Bonett_Wright_Standard_Error_partial)
        ...
        Lower_CI_Semi_Partial = np.tanh(np.arctanh(semi_partial_correlation) - zcrit * Bonett_Wright_Standard_Error_semi_partial)
        Upper_CI_Semi_Partial = np.tanh(np.arctanh(semi_partial_correlation) + zcrit * Bonett_Wright_Standard_Error_semi_partial)
